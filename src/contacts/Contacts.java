...
public class Contacts<Person> {
    ...
    public String enterName() {
        while (true) {
            ...
            if (personLinkedList.matchFound(firstName + " " + lastName)) {
    ...
    public void addContact() {
        ...
        personLinkedList.insertInAlphabeticOrder(new Node<>(person));
    ...
    public void displayAllContacts() {
        if (personLinkedList.getHead() == null) {
            System.out.println("No contacts!");
        } else {
            System.out.println("---Here are all your contacts---");
            Node<Person> temp = personLinkedList.getHead();
            while (temp != null) {
    ...
    public void searchAContact() {
        ...
        LinkedList<Person> searchedPersons = personLinkedList.search(name);
    ...
    public int displayNames() {
        ...
        System.out.println("Here are all your contacts: ");
        return personLinkedList.display();
    }
    ...
    public void deleteAContact() {
        ...
        if (deleteVerified(personLinkedList.getNode(toDelete))) {
            Node<Person> deleted = personLinkedList.delete(toDelete);
    ...
    public void editPersonContact() {
        ...
        Node<Person> contactToEdit = personLinkedList.getNode(toEdit);
